...
public class MeteorOres {
    ...
    private static final ConfiguredFeature<?, ?> DEEPSLATE_TIN_ORE = register(new Identifier(MOD_ID, "deepslate_tin_ore"), Feature.ORE
            ...
            .spreadHorizontally()
            .repeat(6));
    private static final ConfiguredFeature<?, ?> ALUMINUM_ORE = register(new Identifier(MOD_ID, "aluminum_ore"), Feature.ORE
            .configure(new OreFeatureConfig(
                    OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            ...
            .spreadHorizontally()
            .repeat(6));
    private static final ConfiguredFeature<?, ?> DEEPSLATE_ALUMINUM_ORE = register(new Identifier(MOD_ID, "deepslate_aluminum_ore"), Feature.ORE
            .configure(new OreFeatureConfig(
                    OreFeatureConfig.Rules.DEEPSLATE_ORE_REPLACEABLES,
